...
class EducatorTest extends TestCase
{
    ...
    public function testUser(): void
    {
        ...
        $this->assertInstanceOf(Educator::class, $this->entity->setUser($user));
    ...
    public function testDescription(): void
    {
        ...
        $this->assertInstanceOf(Educator::class, $this->entity->setDescription($description));
    ...
    public function testCreatedAt(): void
    {
        ...
        $this->assertInstanceOf(Educator::class, $this->entity->setCreatedAt($createdAt));
    ...
    public function testUpdatedAt(): void
    {
        ...
        $this->assertInstanceOf(Educator::class, $this->entity->setUpdatedAt($updatedAt));
